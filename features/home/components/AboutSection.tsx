          ...
          <div>
            ...
            <div className="space-y-6 max-w-xl">
              ...
              <p className="text-neutral-500 font-bold leading-relaxed">
                Gameshop24 начинался с двух друзей и десяти консолей. Сегодня — это команда из 15 профессиональных геймеров, собственный авторизованный сервис и более 12 000 клиентов по всей РФ.
              </p>
